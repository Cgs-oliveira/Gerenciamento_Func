...
class User:
    def __init__(self, user_id):
        ...
        personal_info_frame = tk.LabelFrame(main_frame, text="Informações Pessoais", bg="#f0f0f0", padx=10, pady=10)
        personal_info_frame.grid(row=0, column=0, sticky='nw', padx=10, pady=10, columnspan=3)
        ...
        buttons_frame.grid(row=1, column=0, sticky='nw', padx=10, pady=10)
        ...
        button_update_endereco = tk.Button(buttons_frame, text="Atualizar Endereço", command=self.update_endereco, bg="#FFC107", fg="white", width=20)
        ...
        tarefas_frame = tk.LabelFrame(main_frame, text="Suas Tarefas", bg="#f0f0f0", padx=10, pady=10)
        tarefas_frame.grid(row=4, column=0, sticky='nw', padx=10, pady=10)
